...
export class HeroInformationsController {
  constructor(private readonly heroInformationsService: HeroInformationsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateHeroInformationDto: UpdateHeroInformationDto) {
